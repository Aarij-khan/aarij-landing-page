...
function Page() {
  ...
  return (
    <div className="bg-neutral-950">
      <div className="border  border-white/15 mx-4 md:rounded-full bg-neutral-950 backdrop-blur sticky top-4 rounded-3xl z-20">
        <div className="w-full p-4 flex justify-center ">
          <div className="w-[90%] xl:w-[60%] flex justify-between items-center h-[7vh] rounded-3xl">
      ...
      <div className="w-full flex justify-center mt-20 overflow-hidden ">
        <div className="w-[90%] lg:w-[50rem] xl:w-[50rem] 2xl:w-[50rem] flex flex-col lg:h-[90vh] items-center gap-6 lg:gap-8 relative ">
          ...
          <div className="w-full md:w-[30rem] border-2 border-white/15 rounded-full h-[8vh] sm:h-[10vh] p-1 flex justify-between gap-1">
            <input
              placeholder="Enter your email"
              className="placeholder:text-gray-400 p-4 w-[60%] sm:w-[75%] border-none outline-none rounded-full h-full bg-black"
            />
            <button className=" rounded-3xl m-1 flex justify-center items-center  px-3 sm:p-4 text-black bg-lime-400 font-semibold">
              Sign Up
            </button>
          </div>
        </div>
      ...
      <div className="w-full flex justify-center">
        <div className="w-[80%] md:w-[80%] flex flex-col justify-center items-center mt-20 h-[25vh]  gap-8 mb-10 overflow-x-clip">
      ...
      <div className="w-full flex flex-col justify-center items-center  ">
        ...
        <div className="w-full flex flex-col justify-center items-center gap-6 mt-[12rem] pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:justify-items-center px-4 ">
            <div className="pt-10 pb-7  p-4 lg:h-[60vh]  sm:w-[300px] bg-neutral-900  rounded-2xl flex flex-col justify-around gap-8 mb-4 sm:ml-4">
            ...
            <div className=" p-4 lg:h-[60vh]  sm:w-[300px] bg-neutral-900  rounded-2xl flex flex-col justify-center gap-3 mb-4 sm:ml-4 relative">
            ...
            <div className="py-10 p-4 lg:h-[60vh]  sm:w-[300px] bg-neutral-900 md:col-span-2  lg:col-span-1 rounded-2xl flex flex-col justify-center gap-4 mb-4 sm:ml-4  ">
        ...
        <div className="flex-col w-[90%] lg:w-[60rem] lg:justify-center flex lg:flex-row gap-8 lg:gap-2 mt-20 pb-20">
          <div className="w-full lg:w-[55%] h-[30vh] lg:h-[50vh] flex flex-col items-center sm:items-start justify-center gap-4 lg:px-10">
        ...
        <div className="w-full mt-14 p-6  flex flex-col md:flex-row md:gap-4 justify-between items-center  bg-neutral-950">
          <div>
            <Image
              src="/images/logo.svg"
              height={100}
